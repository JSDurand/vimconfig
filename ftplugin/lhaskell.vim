inoremap <buffer> <leader>en \begin{code}<cr>\end{code}<esc>O
nnoremap <leader>b  :s /^/><space>/g<cr>
vnoremap <leader>b  :s /^/><space>/g<cr>
nnoremap <leader>bu :s /^><space>//<cr>
vnoremap <leader>bu :s /^><space>//g<cr>
